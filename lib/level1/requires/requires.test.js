...
describe('requires', () => {
  ...
  it('should require file into tag scope', () => {
    const { instructions } = compile(`'./A.in'`);
    expect(instructions).toMatchSnapshot();
  });
  it('should require file Api into tag scope (one dot rule)', () => {
    compile(`'./AM.in'`);
  ...
  it('should require nested file into tag scope', () => {
    const { instructions } = compile(`'./AB.in'`);
    expect(instructions).toMatchSnapshot();
  });
  it('should extend file tag', () => {
    const { instructions } = compile(`'./A.in' is 123 {b is 123}`);
    expect(instructions).toMatchSnapshot();
  });
  it('should append file tag as temporal', () => {
    const { instructions } = compile(`'./A.in' is 123 after b`);
    expect(instructions).toMatchSnapshot();
  });
  it('should prepend file tag as temporal', () => {
  ...
  it('should reference tag scoped file', () => {
