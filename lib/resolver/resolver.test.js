...
describe('resolver', () => {
  ...
  describe('immediate intentions', () => {
    ...
    it('should not resolve nested tag block', () => {
      expect(
        resolve('A1 {A2 {A3}} B1 is A1 {B2 {B3 is A3}}')
      ).toMatchSnapshot();
    });
    it('should resolve nested tag block via one dot rule', () => {
      expect(
  ...
  describe('messages', () => {
    ...
    it('empty message tag', () => {
      expect(resolve('A1() B1 is A1()')).toMatchSnapshot();
    });

    it('missing quantifier message tag hint', () => {
      expect(resolve('A1() B1 is A1(B1)')).toMatchSnapshot();
    });

    it('mismatched message tag', () => {
  ...
  describe('quantifiers', () => {
    it('empty message to optional message tag', () => {
      expect(resolve('A1(?) B1 is A1()')).toMatchSnapshot();
    });
    it('empty message to + message tag', () => {
      expect(resolve('A1(+) B1 is A1()')).toMatchSnapshot();
    });
  });
  ...
  describe('custom selectors', () => {
    it('should resolve dsl', () => {
      expect(resolve("cell:`'X'[\\\\d]` is tag X1")).toMatchSnapshot();
    });
  });

  describe('aggregation', () => {
    it('should maintain aggregated tag map', () => {
      resolve('A1 is 1');
